...
from functions.Logic import checkIfTitleExists, isInTypeList, getAllTypes, getMinPriceofType, isInPriceList, \
    getAllPrices, countedTitle, UIadaugaCarte, deleteBookbyId, changeBookData, applyDiscounts, modifyTypeByTitle, \
...
def testAllLogicFunctions():
    ...
    assert UIadaugaCarte("4", "Mara", "Nuvela", 20, "silver", ) == ("4", "Mara", "Nuvela", 20, "silver")

    assert deleteBookbyId(lista, "3") == [ ("1", "Dumbrava minunata", "Basm", 15, "none"), ("2", "Povestea lui Harap-Alb", "Basm", 1, "none") ]
    ...
    assert checkIfTitleExists(lista, "Povestea lui Harap-Alb") == True
    ...
    assert countedTitle(lista, "Ion") == False
